...
namespace SampleBrowser.Maui.Calendar.SfCalendar
{
    ...
    public partial class AppointmentBooking : SampleView
    {
        ...
        public AppointmentBooking()
        {
            ...
            this.frame.Stroke = Colors.Transparent;
        ...
        {
#if MACCATALYST
            this.UpdateTimeSlotSelection(this.appointmentBooking1, (SfButton)sender, this.flexLayout1);
#elif !ANDROID && !IOS
            this.UpdateTimeSlotSelection(this.appointmentBooking, (SfButton)sender, this.flexLayout);
#else
            if (DeviceInfo.Idiom == DeviceIdiom.Tablet)
            {
                this.UpdateTimeSlotSelection(this.appointmentBooking1, (SfButton)sender, this.flexLayout1);
            ...
            {
                this.UpdateTimeSlotSelection(this.mobileAppointmentBooking, (SfButton)sender, this.mobileFlexLayout);
            }
#endif
        }
        ...
        /// <param name="buttonLayout">Time slot button layout.</param>
        private void UpdateTimeSlotSelection(Syncfusion.Maui.Calendar.SfCalendar calendar, SfButton selectedButton, FlexLayout buttonLayout)
        {
            if (calendar.SelectedDate == null)
            {
                this.popUp.HeaderTitle = "Alert !";
