...
{
    public class AdaptiveResourceViewModel
    {
        /// <summary>
        ...
        /// <summary>
        /// Gets or sets the hamburger icon command.
        /// </summary>
        public ICommand HamburgerIconCommand { get; set; }

        /// <summary>
        /// Initializes a new instance of the <see cref="AdaptiveResourceViewModel" /> class.
        /// </summary>
        public AdaptiveResourceViewModel()
        {
        ...
        /// <summary>
        /// Called when hamburger icon tapped.
        /// </summary>
        /// <param name="obj">The scheduler adaptive resource.</param>
