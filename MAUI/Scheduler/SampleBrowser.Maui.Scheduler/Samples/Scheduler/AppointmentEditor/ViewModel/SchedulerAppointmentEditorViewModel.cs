...
{
    /// <summary>
    /// The appointment editor View Model.
    /// </summary>
    public class SchedulerAppointmentEditorViewModel
    {
        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulerAppointmentEditorViewModel" /> class.
        /// </summary>
        public SchedulerAppointmentEditorViewModel()
        {
