namespace SampleBrowser.Maui.Scheduler.SfScheduler
{
    ...
    /// <summary>
    /// Provides the view model for the clipboard sample, which initializes a collection of scheduler appointments and sets the display date for the scheduler control.
    /// </summary>
    public class SchedulerClipboardViewModel
    {
        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulerClipboardViewModel" /> class.
        /// </summary>
        public SchedulerClipboardViewModel()
        {
        ...
        /// <summary>
        /// Method to generate the scheduler appointments.
        /// </summary>
