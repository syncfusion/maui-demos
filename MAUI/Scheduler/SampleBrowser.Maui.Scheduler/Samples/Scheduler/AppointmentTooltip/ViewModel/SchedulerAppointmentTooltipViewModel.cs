...
{
    /// <summary>
    /// The appointment tooltip View Model.
    /// </summary>
    public class SchedulerAppointmentTooltipViewModel
    {
        #region Constructor

        /// <summary>
        /// Initializes a new instance of the <see cref="SchedulerAppointmentTooltipViewModel" /> class.
        /// </summary>
        public SchedulerAppointmentTooltipViewModel()
        {
