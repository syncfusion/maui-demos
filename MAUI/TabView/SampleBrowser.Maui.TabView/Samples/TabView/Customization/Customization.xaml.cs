...
namespace SampleBrowser.Maui.TabView.SfTabView
{
    ...
    public partial class Customization : SampleView
    {
        ...
        {
            SfTabItem? item = null;
            Syncfusion.Maui.TabView.SfTabView? view = null;

            if (sender is Syncfusion.Maui.TabView.SfTabView tabView)
            {
                view = tabView;
                item = view.Items[(int)e.NewIndex];
            }
            ...
            {
                this.SelectedItemColor = brush.Color;
