...
public partial class Selection : SampleView
{
    ...
    private void selectionFill_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        if (selectedIndex == 0)
        {
            selection.Fill = new SolidColorBrush(Color.FromArgb("#ed008c"));
        }
        else if (selectedIndex == 1)
        {
            selection.Fill = new SolidColorBrush(Color.FromArgb("#BD34B7"));
        }
        else if (selectedIndex == 2)
        {
            selection.Fill = new SolidColorBrush(Color.FromArgb("#FF6347"));
        }
    }
    ...
    private void selectionStroke_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        {
            selection.Stroke = Colors.Yellow;
        }
        else if (selectedIndex == 2)
        {
