...
namespace SampleBrowser.Maui.SunburstChart.SfSunburstChart
{
    public class ViewModel : BaseViewModel
    {
        ...
        public string[] DataLabelOption => ["Angle", "Normal"];
        public string[] DataLabelOption1 => ["Trim", "Hide"];
        public string[] SelectionType => ["Child", "Parent", "Single", "Group" ];
        public string[] SelectionDisplayMode => ["Fill", "Opacity", "Stroke"];
        public string[] SelectionFill => ["Mexican Pink", "Dark Yellow", "Tomato Red"];
        public string[] SelectionStroke => ["Black", "Yellow", "Turquoise"];
        ...
        public ViewModel()
        {
            ...
            DataSource4 = [
                new Model ( "A0", "A0A1", "A0A00", 73 ),
                new Model ( "A0", "A0A1", "A0A01", 53 ),
                new Model ( "A0", "A0A1", "A0A02", 34 ),
                new Model ( "A0", "A0B1",  47 ),
                new Model ( "A0", "A0C1",  25 ),
                new Model ( "B0", "B0A1", "B0A00", 69 ),
                new Model ( "B0", "B0A1", "B0A01", 44 ),
                new Model ( "B0", "B0B1",  79 ),
                new Model ( "B0", "B0C1", "B0C00", 39 ),
                new Model ( "B0", "B0C1", "B0C01", 54 ),
                new Model ( "C0", "C0A1", "C0A00", 108 ),
                new Model ( "C0", "C0A1", "C0A01", 53 ),
                new Model ( "C0", "C0A1", "C0A02", 67 ),
                new Model ( "C0", "C0B1", 47 ),
                new Model ( "C0", "C0C1", 34 ),
            ];
        }
    }
}