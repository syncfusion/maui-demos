...
public partial class SmartFillView : SampleView
{
    ...
    private async void Clipboard_ClipboardContentChanged(object? sender, EventArgs e)
    {
        ...
        if (_smartAI.ChatCompletions != null)
        {
            SubmitForm.IsEnabled = true;
        }
        else if (_smartAI.ChatCompletions == null && (copiedText == viewModel.UserDetail1 || copiedText == viewModel.UserDetail2 || copiedText == viewModel.UserDetail3))
        {
            SubmitForm.IsEnabled = true;
        }
        else
