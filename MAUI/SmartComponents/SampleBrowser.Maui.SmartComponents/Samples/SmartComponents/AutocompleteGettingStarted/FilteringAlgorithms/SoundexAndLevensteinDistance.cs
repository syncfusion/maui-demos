...
namespace SampleBrowser.Maui.SmartComponents.SmartComponents
{
    ...
    {      
        ...
        public SoundexAndLevensteinDistance()
        {
        ...
        /// </summary>
        /// <returns></returns>
        public ObservableCollection<CountryModel> GetOrder()
        {
            ObservableCollection<CountryModel> orderedSource = new ObservableCollection<CountryModel>();
            for (int i = 0; i < 10; i++)
            {
                int count = 0;
                for (int c = 0; c < filteredSearchResults.Count; c++)
                {
                    ...
                    {
                        orderedSource.Add( new CountryModel() { Name = filteredSearchResults[c].Item! });
                    }
                }
            }
