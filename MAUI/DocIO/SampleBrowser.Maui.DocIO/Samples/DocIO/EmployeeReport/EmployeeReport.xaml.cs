    ...
    public partial class EmployeeReport : SampleView
    {
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            ...
            if (BaseConfig.IsIndividualSB)
                dataPathEmployee = @"SampleBrowser.Maui.DocIO.Resources.DocIO.EmployeesReportDemo.docx";
        ...
        private MailMergeDataTable GetMailMergeDataTableEmployee()
        {
            ...
            string dataPathEmployee = @"SampleBrowser.Maui.Resources.DocIO.EmployeesList.xml";
            if (BaseConfig.IsIndividualSB)
                dataPathEmployee = @"SampleBrowser.Maui.DocIO.Resources.DocIO.EmployeesList.xml";
            //Reads data from xml.
            Stream? fileStream = assembly.GetManifestResourceStream(dataPathEmployee);
