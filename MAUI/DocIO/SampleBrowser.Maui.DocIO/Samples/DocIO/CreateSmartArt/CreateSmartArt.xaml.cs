...
namespace SampleBrowser.Maui.DocIO.DocIO
{
    ...
    public partial class CreateSmartArt : SampleView
    {
        ...
        private void Button_Click(object sender, EventArgs e)
        {
            ...
            using Stream? fileStream = assembly.GetManifestResourceStream(basePath + "CreateSmartArtInput.docx");
            //Loads an existing Word document.
            using WordDocument document = new(fileStream, FormatType.Docx);

            string filename = "";
            switch (SmartArtType.Text)
            {
                case "List":
                ...
                case "Picture":
                    ...
                    CreatePictureSmartArt(document, basePath);
            ...
            saveService.SaveAndView(filename, "application/msword", ms);
        }
