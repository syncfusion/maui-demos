...
public partial class LinearProgressBar : SampleView
{
    ...
    {
        base.OnDisappearing();
        CornerRadiusProgressBar.Handler?.DisconnectHandler();
        PaddingProgressBar.Handler?.DisconnectHandler();
        RangeProgressBar.Handler?.DisconnectHandler();
        GradientProgressBar.Handler?.DisconnectHandler();
        SecondaryProgressProgressBar.Handler?.DisconnectHandler();
        SegmentedProgressBar.Handler?.DisconnectHandler();
        SegmentedCornerRadiusProgressBar.Handler?.DisconnectHandler();
        DeterminateProgressBar.Handler?.DisconnectHandler();
        IndeterminateProgressBar.Handler?.DisconnectHandler();
    }
}