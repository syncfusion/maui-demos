...
namespace SampleBrowser.Maui.SmartDataGrid
{
    public class OrderInfoRepository
    {
        ...
        {
                 new AssistSuggestion() {Text = "Which orders have a payment status of Pending?"},
                  new AssistSuggestion() {Text ="What are the top 10 orders with the highest freight cost?"},
                     new AssistSuggestion() {Text = "Which customers have placed the most orders?"},
                           new AssistSuggestion() {Text = "Show all orders shipped to a specific country or city."},
