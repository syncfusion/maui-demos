...
namespace SampleBrowser.Maui.CartesianChart.SfCartesianChart
{
    public partial class ShapeAnnotationSample : SampleView
    {
        ...
        private async void Chart_AnnotationTapped(object? sender, AnnotationTappedEventArgs e)
        {
            ...
            {
                // Toggle ColorMode to force complete re-render
                var currentMode = ColorPicker.ColorMode;
                ColorPicker.ColorMode = ColorPickerMode.Spectrum;
                ColorPicker.ColorMode = currentMode;
            });
#endif
