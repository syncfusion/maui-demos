...
#endif          
#if IOS || MACCATALYST
            Type? type = typeof(Syncfusion.Maui.Popup.SfPopup);
            MethodInfo? refreshMethod = type!.GetMethod("Refresh", BindingFlags.NonPublic | BindingFlags.Instance);
            refreshMethod!.Invoke(ActionSheetPopup, null);
#endif
