namespace SampleBrowser.Maui.ImageEditor.SfImageEditor
{
    ...
    public class ImageFilterBehavior : Behavior<SampleView>
    {
        ...
        protected override void OnAttachedTo(SampleView sampleView)
        {
            ...
            this.imageEditor.ImageLoaded += OnImageEditorImageLoaded;
        ...
        /// <summary>
        /// Invokes on main image editor instance loaded.
        /// </summary>
        /// <param name="sender">The image editor.</param>
        /// <param name="e">The event arguments.</param>
        private void OnImageEditorImageLoaded(object? sender, EventArgs e)
        {
            if (this.imageEditor?.Source == null || this.filtersList?.ItemsSource == null)
            {
                return;
            }

            // When a new image is loaded into the main ImageEditor, regenerate the preview images from the filters list.
            if (this.filtersList.ItemsSource is IEnumerable<ImageFilterModel> items)
            {
        ...
        /// <param name="sender">The image editor.</param>
        /// <param name="e">The event arguments.</param>
        private void OnPreviewImageEditorImageLoaded(object? sender, EventArgs e)
        {
        ...
        private void AddListViewItems()
        {
...
#if ANDROID
            this.effectsView.InputTransparent = true;
#endif
            ...
            this.filtersList.ItemTemplate = new DataTemplate(() =>
            {
                ...
                previewEditor.ImageLoaded += OnPreviewImageEditorImageLoaded;
