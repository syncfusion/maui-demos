...
namespace SampleBrowser.Maui.Cards.SfCards
{
    public class CardManagerBehavior : Behavior<SampleView>
    {
        ...
        private Frame? firstCardDetails, secondCardDetails, thirdCardDetails, firstCardDue, secondCardDue, thirdCardDue, cardManagerFrame, cardDetailsFrame;
        ...
        protected override void OnAttachedTo(SampleView sampleView)
        {
            ...
            this.cardManagerFrame = sampleView.Content.FindByName<Frame>("cardManagerFrame");
            this.cardDetailsFrame = sampleView.Content.FindByName<Frame>("cardDetailsFrame");
