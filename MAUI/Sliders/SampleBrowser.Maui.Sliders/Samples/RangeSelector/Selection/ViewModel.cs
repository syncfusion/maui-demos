...
{
    public class RangeSelectorSelectionSampleViewModel : INotifyPropertyChanged
    {
        public event PropertyChangedEventHandler? PropertyChanged;
        private DateTime rangeStart = new(2019, 04, 06);
        private DateTime rangeEnd = new(2019, 04, 16);
        ...
        private void UpdatePaletteBrushes()
        {
            ...
            foreach (ChartDataModel item in Items)
            {
                ...
                {
                    PaletteBrushes.Add(new SolidColorBrush(Color.FromArgb("#D467FA")));
                }
                else
                {
                    PaletteBrushes.Add(new SolidColorBrush(Color.FromArgb("#EAEAEA")));
                }
            }
        ...
        public RangeSelectorSelectionSampleViewModel()
        {
