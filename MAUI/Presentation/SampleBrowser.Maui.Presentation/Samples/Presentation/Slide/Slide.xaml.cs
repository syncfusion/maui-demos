    ...
    public partial class Slide : SampleView
    {
        ...
        private void OnButtonClicked(object sender, EventArgs e)
        {
            ...
            if (BaseConfig.IsIndividualSB)
                resourcePath = "SampleBrowser.Maui.Presentation.Resources.Presentation.Slides.pptx";
        ...
        private static void CreateThirdSlide(IPresentation presentation)
        {
            ...
            if (BaseConfig.IsIndividualSB)
                resourcePath = "SampleBrowser.Maui.Presentation.Resources.Presentation.tablet.jpg";
