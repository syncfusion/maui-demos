...
namespace SampleBrowser.Maui.LiquidGlass.SfSegmentedControl
{
    ...
    public class GettingStartedViewModel : INotifyPropertyChanged
    {
        ...
        private void InitializeSegmentItemsColorsInfo()
        {
            ...
            {
                new SfSegmentItem() { Text = "Blue", TextStyle = new SegmentTextStyle() { TextColor = Color.FromArgb("#8EAEDC"), FontSize = 14, FontFamily = "Roboto" } },
                new SfSegmentItem() { Text = "Grey", TextStyle = new SegmentTextStyle() { TextColor = Color.FromArgb("#A4AAB4"), FontSize = 14, FontFamily = "Roboto" } },
                new SfSegmentItem() { Text = "Green", TextStyle = new SegmentTextStyle() { TextColor = Color.FromArgb("#7DC59D"), FontSize = 14, FontFamily = "Roboto" } },
                new SfSegmentItem() { Text = "Pink", TextStyle = new SegmentTextStyle() { TextColor = Color.FromArgb("#F5878F"), FontSize = 14, FontFamily = "Roboto" } },
                new SfSegmentItem() { Text = "Sandals", TextStyle = new SegmentTextStyle() { TextColor = Color.FromArgb("#C7B690"), FontSize = 14, FontFamily = "Roboto" } },
            };
