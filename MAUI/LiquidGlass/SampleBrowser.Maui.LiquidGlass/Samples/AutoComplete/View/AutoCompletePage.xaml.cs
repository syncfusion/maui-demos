...
namespace SampleBrowser.Maui.LiquidGlass.SfAutoComplete;

/// <summary>
/// 
/// </summary>
public partial class AutoCompletePage : SampleView
{
    /// <summary>
    /// 
    /// </summary>
    ...
    {
        if (CountryList != null && CountryList.Contains(countryAutoComplete.SelectedItem) && JobList != null && JobList.Contains(jobFieldAutoComplete.SelectedItem))
        {
            Random r = new Random();
#if NET10_0
            Application.Current?.Windows[0].Page?.DisplayAlertAsync("Results", "There are " + r.Next(9, 50) + " " + jobFieldAutoComplete.SelectedItem + " jobs found in " + countryAutoComplete.SelectedItem + ".", "Ok");
#else
            Application.Current?.Windows[0].Page?.DisplayAlert("Results", "There are " + r.Next(9, 50) + " " + jobFieldAutoComplete.SelectedItem + " jobs found in " + countryAutoComplete.SelectedItem + ".", "Ok");
#endif
        }
        else
        {
#if NET10_0
            Application.Current?.Windows[0].Page?.DisplayAlertAsync("Results", "0 job found", "OK");
#else
            Application.Current?.Windows[0].Page?.DisplayAlert("Results", "0 job found", "OK");
#endif
        }
    }
