...
namespace SampleBrowser.Maui.LiquidGlass.SfTimePicker
{
    ...
    /// <summary>
    /// Converts a <see cref="TimeSpan"/> value to a 12-hour time string with an AM/PM meridian indicator for use in
    /// data binding scenarios.
    /// </summary>
    public class TimeSpanToMeridianConverter : IValueConverter
    {
