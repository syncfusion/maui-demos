namespace SampleBrowser.Maui.Gauges.SfDigitalGauge
{
    ...
    {
        //Sliders.
        private Slider? characterHeight;
        private Slider? characterWidth;
        private Slider? characterSpacing;
        private Slider? characterStrokeWidth;
        private Slider? disabledSegmentAlpha;
        ...
        protected override void OnAttachedTo(SampleView bindable)
        {
            ...
            this.disabledSegmentAlpha = bindable.Content.FindByName<Slider>("disabledSegmentAlpha");
            this.characterWidth = bindable.Content.FindByName<Slider>("characterWidth");
            this.characterHeight = bindable.Content.FindByName<Slider>("characterHeight");
            this.characterStrokeWidth = bindable.Content.FindByName<Slider>("strokeWidth");
            this.characterSpacing = bindable.Content.FindByName<Slider>("characterSpacing");
        ...
        private void DisabledSegmentAlphaChanged(object? sender, ValueChangedEventArgs e)
        {
            if (this.viewModel != null)
            {
        ...
        private void CharacterWidthChanged(object? sender, ValueChangedEventArgs e)
        {
            if (this.viewModel != null)
            {
        ...
        private void CharacterHeightChanged(object? sender, ValueChangedEventArgs e)
        {
            if (this.viewModel != null)
            {
        ...
        private void CharacterSpacingChanged(object? sender, ValueChangedEventArgs e)
        {
            if (this.viewModel != null)
            {
        ...
        private void CharacterStrokeWidthChanged(object? sender, ValueChangedEventArgs e)
        {
            if (this.viewModel != null)
            {
