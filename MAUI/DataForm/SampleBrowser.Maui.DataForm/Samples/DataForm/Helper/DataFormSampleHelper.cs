...
namespace SampleBrowser.Maui.DataForm.SfDataForm
{
    ...
    internal static class DataFormSampleHelper
    {
        /// <summary>
        ...
        internal static Style GetOkButtonStyle()
        {
            return new Style(typeof(Button))
            {
                Setters =
                {
                    ...
                    new Setter { Property = Button.BackgroundColorProperty, Value = DataFormSampleHelper.GetDynamicColor("SfDataFormFocusedEditorStroke") },
                    new Setter { Property = Button.TextColorProperty, Value = DataFormSampleHelper.GetDynamicColor() },
        ...
        internal static DataTemplate GetFooterTemplate(SfPopup popup)
        {
            var footerTemplate = new DataTemplate(() =>
            {
                ...
                {
                    Text = "OK",
                    Style = DataFormSampleHelper.GetOkButtonStyle(),
                    WidthRequest = 96,
                    HeightRequest = 40
                };
        ...
        internal static DataTemplate GetContentTemplate(SfPopup popup, bool? isValidate = false)
        {
            ...
            var footerTemplate = new DataTemplate(() =>
            {
                ...
                stackLayout.SetDynamicResource(StackLayout.BackgroundColorProperty, "SfDataFormDisabledEditorStroke");
