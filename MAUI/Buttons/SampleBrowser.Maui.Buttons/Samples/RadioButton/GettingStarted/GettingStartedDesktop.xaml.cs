...
public partial class GettingStartedDesktop:SampleView
{
    ...
    private void PayDirect_StateChanged(object sender, Syncfusion.Maui.Buttons.StateChangedEventArgs e)
    {
        if (e.IsChecked == true)
        {
            ...
            grid3.Stroke = Application.Current!.UserAppTheme == AppTheme.Dark ? (Color)App.Current.Resources["PrimaryBackground"] : (Color)App.Current.Resources["PrimaryBackgroundLight"];
        }
        else 
        {
            grid3.BackgroundColor = Colors.Transparent;
            grid3.Stroke = Colors.LightGray;
        }
    }
    ...
    private void Visa_StateChanged(object sender, Syncfusion.Maui.Buttons.StateChangedEventArgs e)
    {
        if (e.IsChecked == true)
        {
            ...
            grid2.Stroke = Application.Current!.UserAppTheme == AppTheme.Dark ? (Color)App.Current.Resources["PrimaryBackground"] : (Color)App.Current.Resources["PrimaryBackgroundLight"];
        }
        else {
            grid2.BackgroundColor = Colors.Transparent;
            grid2.Stroke = Colors.LightGray;
        }
    }
    ...
    private void MasterCard_StateChanged(object sender, Syncfusion.Maui.Buttons.StateChangedEventArgs e)
    {
        if (e.IsChecked == true)
        {
            ...
            grid1.Stroke = Application.Current!.UserAppTheme == AppTheme.Dark ? (Color)App.Current.Resources["PrimaryBackground"] : (Color)App.Current.Resources["PrimaryBackgroundLight"];
        }
        else 
        {
            grid1.BackgroundColor = Colors.Transparent;
            grid1.Stroke = Colors.LightGray;
        }
    }
    ...
    private void noCost_StateChanged(object sender, Syncfusion.Maui.Buttons.StateChangedEventArgs e)
    {
        if(e.IsChecked==true) 
        {
            ...
            grid4.Stroke = Application.Current!.UserAppTheme == AppTheme.Dark ? (Color)App.Current.Resources["PrimaryBackground"] : (Color)App.Current.Resources["PrimaryBackgroundLight"];
        }
        else 
        {
            grid4.BackgroundColor = Colors.Transparent;
            grid4.Stroke = Colors.LightGray;
        }
    }
    ...
    private void nineMonths_StateChanged(object sender, Syncfusion.Maui.Buttons.StateChangedEventArgs e) 
    {
        if (e.IsChecked == true) 
        {
            ...
            grid5.Stroke = Application.Current!.UserAppTheme == AppTheme.Dark ? (Color)App.Current.Resources["PrimaryBackground"] : (Color)App.Current.Resources["PrimaryBackgroundLight"];
        }
        else 
        {
            grid5.BackgroundColor = Colors.Transparent;
            grid5.Stroke = Colors.LightGray;
        }
    }
    ...
    private void twelveMonths_StateChanged(object sender, Syncfusion.Maui.Buttons.StateChangedEventArgs e)
    {
        if (e.IsChecked == true) 
        {
            ...
            grid6.Stroke = Application.Current!.UserAppTheme == AppTheme.Dark ? (Color)App.Current.Resources["PrimaryBackground"] : (Color)App.Current.Resources["PrimaryBackgroundLight"];
        }
        else 
        {
            grid6.BackgroundColor = Colors.Transparent;
            grid6.Stroke = Colors.LightGray;
        }
    }
}