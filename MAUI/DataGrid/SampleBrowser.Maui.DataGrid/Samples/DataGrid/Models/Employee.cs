...
namespace SampleBrowser.Maui.DataGrid
{
    public class Employee : INotifyPropertyChanged, IDataErrorInfo
    {
        ...
        /// </summary>
        [StringLength(6, MinimumLength = 5, ErrorMessage = "Length must be 5–6.")]
        public string? Name
        {
            get
            {
        ...
        /// </summary>
        //[NotIn("Graz", "Montral", ErrorMessage = "Delivery not available for this City")]
        [RegularExpression("^(?!Belgium|Canada).*$", ErrorMessage = "Delivery not available for this City")]
