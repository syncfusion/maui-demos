...
public partial class MaskedEntryGettingStartedMobile : SampleView
{
	public MaskedEntryGettingStartedMobile()
	{
		InitializeComponent();
	}
    ...
    private void ValidationModeComboBox_SelectionChanged(object sender, Syncfusion.Maui.Inputs.SelectionChangedEventArgs e)
    {
        switch (validationModeComboBox.SelectedIndex)
        {
            case 0:
                ...
                debitMask.ValidationMode = InputValidationMode.LostFocus;
                break;
            case 1:
                ...
                debitMask.ValidationMode = InputValidationMode.KeyPress;
                break;
        }
