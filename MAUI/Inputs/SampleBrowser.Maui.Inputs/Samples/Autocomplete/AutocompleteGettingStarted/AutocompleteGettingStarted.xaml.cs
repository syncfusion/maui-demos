...
public partial class AutocompleteGettingStarted : SampleView
{
    ...
    void Handle_Clicked(object sender, System.EventArgs e)
    {
        if (CountryList != null && CountryList.Contains(countryAutoComplete.SelectedItem) && JobList != null && JobList.Contains(jobFieldAutoComplete.SelectedItem))
        {
            ...
            Application.Current?.MainPage?.DisplayAlert("Results", "There are " + r.Next(9, 50) + " " + jobFieldAutoComplete.SelectedItem + " jobs found in " + countryAutoComplete.SelectedItem + ".", "Ok");
        }
        else
        {
            Application.Current?.MainPage?.DisplayAlert("Results", "0 job found", "OK");
        }
    }
