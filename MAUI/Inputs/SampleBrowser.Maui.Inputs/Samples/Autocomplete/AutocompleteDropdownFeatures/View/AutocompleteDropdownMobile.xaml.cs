...
public partial class AutocompleteDropdownMobile : SampleView
{
	public AutocompleteDropdownMobile()
	{
		InitializeComponent();
    ...
    private void CornerRadiusSlider_ValueChanged(object? sender, ValueChangedEventArgs e)
    {
        ...
        autocompleteDropdownCustomization.DropDownCornerRadius = value;
    }
}