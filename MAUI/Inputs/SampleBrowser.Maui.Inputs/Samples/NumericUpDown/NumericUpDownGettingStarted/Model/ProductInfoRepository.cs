...
namespace SampleBrowser.Maui.Inputs.Samples.NumericUpDown.NumericUpDownGettingStarted.Model
{
    public class ProductInfoRepository
    {
        ...
        {            
            "Savor the luscious and irresistible allure of imported cherries. Indulge in their vibrant colors, tantalizing sweetness, and delicate texture as you embark on a sensory journey like no other. Delight your senses with their juicy burst and vibrant colors. Order now and embark on a journey of pure indulgence with our premium selection of imported cherries.",
            "The orange is a popular fruit known for its vibrant color, refreshing taste, and high nutritional value. It belongs to the citrus family and is scientifically called Citrus sinensis. Oranges are widely cultivated in many parts of the world and are consumed in various forms, including fresh, juiced, or used in cooking and baking.",
             "Elevate your culinary creations and indulge in the irresistible allure of our premium strawberries. Perfect for adding a touch of elegance to your summer desserts, cocktails, or simply enjoyed as a refreshing snack, these nature's red jewels are a must-have for strawberry lovers. Order now and experience the sumptuous delight of our fresh and flavorful strawberries. Let their juicy sweetness captivate your senses and bring a burst of natural indulgence to your everyday moments.",
             "Delve into the mouthwatering world of peaches. Peaches are a true embodiment of summertime bliss, offering an exquisite sensory experience that will transport you to sun-kissed orchards and warm, lazy afternoons. Order now and indulge in the captivating taste and vibrant colors of our premium peaches, bringing a slice of summer to your table.",
             ...
             "Raspberries are small berries with a round shape and a deep red color. They are made up of numerous small drupelets, which are individual sections that make up the fruit. Raspberries can also be found in other colors such as black, purple, yellow, and golden.Raspberries have a sweet and slightly tangy taste with a hint of acidity. The flavor can vary depending on the variety and level of ripeness. Ripe raspberries are juicy and fragrant.",
             "Grapes are small, round or oval-shaped fruits that grow in clusters on woody vines of the genus Vitis. They are one of the oldest cultivated fruits and have been enjoyed by humans for thousands of years.Grapes are a nutrient-dense fruit. They are a good source of vitamins C and K, as well as antioxidants and various minerals. ",
             "Blueberries are small, round berries that belong to the genus Vaccinium. They are known for their deep blue or purple color and have a sweet and tangy flavor. Blueberries are native to North America but are now cultivated in many regions around the world.Blueberries are often regarded as a superfood due to their high nutritional content. They are low in calories but rich in vitamins C and K. Blueberries are also an excellent source of dietary fiber and are packed with antioxidants"
        };
