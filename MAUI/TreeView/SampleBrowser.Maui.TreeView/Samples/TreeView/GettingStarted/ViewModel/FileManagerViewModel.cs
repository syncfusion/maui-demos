using SampleBrowser.Maui.TreeView.SfTreeView;
    ...
    internal class FileManagerViewModel : INotifyPropertyChanged
    {
        ...
        public string FilterText
        {
            ...
            set
            {
                ...
                this.OnPropertyChanged(nameof(this.FilterText));
            }
        }

        public bool EnableCancelIcon
        {
            get { return this.enableCancelIcon; }
            set
            {
                this.enableCancelIcon = value;
                this.OnPropertyChanged(nameof(this.EnableCancelIcon));
            }
        }
        ...
        public FileManagerViewModel() 
        {
            ...
            this.ClearFilterCommand = new Command(ExecuteClearFilter);
        }
        ...
        private void OnPropertyChanged(string name)
        {
            ...
            {
                if (name == nameof(this.FilterText))
                {
                    this.EnableCancelIcon = !string.IsNullOrEmpty(this.FilterText);
                }
