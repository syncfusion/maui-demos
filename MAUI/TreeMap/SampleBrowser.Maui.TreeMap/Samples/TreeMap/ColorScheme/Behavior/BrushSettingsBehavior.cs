namespace SampleBrowser.Maui.TreeMap.SfTreeMap
{
    ...
    internal class BrushSettingsBehavior : Behavior<SampleView>
    {
        ...
        /// </summary>
        private Picker? brushSettingsPicker;
        ...
        protected override void OnAttachedTo(SampleView sampleView)
        {
            ...
            this.brushSettingsPicker = sampleView.FindByName<Picker>("brushSettingsPicker");

            if (this.brushSettingsPicker != null)
            {
                this.brushSettingsPicker.SelectedIndexChanged += BrushSettingsPicker_SelectedIndexChanged;
            }
        }
        ...
        protected override void OnDetachingFrom(SampleView sampleView)
        {
            ...
            if (this.brushSettingsPicker != null)
            {
                this.brushSettingsPicker.SelectedIndexChanged -= this.BrushSettingsPicker_SelectedIndexChanged;
        ...
        private void BrushSettingsPicker_SelectedIndexChanged(object? sender, EventArgs e)
        {
