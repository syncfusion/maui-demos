...
namespace SampleBrowser.Maui.TreeMap.SfTreeMap
{
    ...
    public class GettingStartedViewModel
    {
        ...
        public GettingStartedViewModel()
        {
            ...
            this.SelectionModeInfo = Enum.GetValues<Syncfusion.Maui.TreeMap.SelectionMode>();
            this.LayoutTypeInfo = Enum.GetValues<Syncfusion.Maui.TreeMap.LayoutType>();
            this.TextFormatOptionInfo = Enum.GetValues<Syncfusion.Maui.TreeMap.TextFormatOption>();
        }
