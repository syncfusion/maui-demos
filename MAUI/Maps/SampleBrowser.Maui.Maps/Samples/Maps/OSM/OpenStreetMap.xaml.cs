...
public partial class OpenStreetMap : SampleView
{
    ...
    public OpenStreetMap()
	{
        ...
        // Set initial selection to Chichen Itza
        previousSelectedButton = ChichenItzaButton;
        if (previousSelectedButton != null)
        {
            previousSelectedButton.Background = Color.FromRgba("#6750A4");
            previousSelectedButton.TextColor = Colors.White;
        }
    }
