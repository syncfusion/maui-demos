...
namespace SampleBrowser.Maui.Chat.SfChat
{
    ...
    public class GettingStartedViewModel : INotifyPropertyChanged
    {
        ...
        private string messageCount = string.Empty;
        ...
        public GettingStartedViewModel()
        {
            ...
            this.InitConvo();
            SendMessageCommand = new Command<object>(SendMessage);
        }
        ...
        public ICommand? SendMessageCommand
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(nameof(this.SendMessageCommand));
            }
        }
        ...
        public string MessageCount
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(nameof(this.MessageCount));
            }
        }
        ...
        public ChatTypingIndicator? TypingIndicator
        {
            ...
            private set
            {
                ...
                RaisePropertyChanged(nameof(this.TypingIndicator));
            }
        }
        ...
        public bool? ShowTypingIndicator
        {
            ...
            private set
            {
                ...
                RaisePropertyChanged(nameof(this.ShowTypingIndicator));
            }
        }
        ...
        public bool IsBadgeViewVisible
        {
            ...
            set
            {
                ...
                RaisePropertyChanged(nameof(this.IsBadgeViewVisible));
            }
        }
        ...
        private void InitializeAuthors()
        {
            ...
            var author6 = new Author() { Name = "Michael" };
        ...
        {            
            ...
            var message = (this.Messages[Math.Max(0, this.Messages.Count - 1)] as TextMessage);
            if (message != null)
            {
            ...
            for (int i = 1; i < this.messageList.Count; i++)
            {
                ...
                message = this.CreateMessage(this.messageList[i], this.AuthorMessageDataBase[i]);
        ...
        /// <summary>
        /// Handles the send message command by updating the delivery state of the sent message to <see cref="DeliveryStates.Sent"/>.
        /// </summary>
        /// <param name="parameter">
        /// The command parameter, expected to be of type <see cref="SendMessageEventArgs"/> containing the message to update.
        /// </param>
        public void SendMessage(object parameter)
        {
            if (parameter is SendMessageEventArgs args && args.Message != null)
            {
                args.Message.DeliveryState = DeliveryStates.Delivered;
            }
        }
        ...
        private void AuthorStartedTyping(Author auth)
        {
            if (auth != this.CurrentUser)
            {
                ...
                if (auth.Avatar != null && auth.Name != null)
                {
