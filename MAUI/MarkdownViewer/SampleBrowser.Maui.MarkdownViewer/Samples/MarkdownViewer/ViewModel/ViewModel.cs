namespace SampleBrowser.Maui.MarkdownViewer.SfMarkdownViewer
{
    public class ViewModel : BaseViewModel
    {
        ...
        private static readonly ResourceDictionary MarkdownResource
            = new MarkdownStyleResources();
        ...
        public ViewModel()
        {
            ...
            MarkdownResource.TryGetValue(Application.Current!.RequestedTheme == AppTheme.Dark ? "WeatherDarkStyle" : "WeatherLightStyle", out var style);
