...
public class NavigationDrawerBehavior : Behavior<SampleView>
{
    ...
    private SfComboBox? positionType;
    ...
    //secondary drawer
    private SfComboBox? secondarydrawertransitionType;
    private SfComboBox? secondarydrawerpositionType;
    ...
    protected override void OnAttachedTo(SampleView bindable)
    {
        ...
        this.transitionType = bindable.FindByName<SfComboBox>("transitioncomboBox");
        ...
        this.positionType = bindable.FindByName<SfComboBox>("positioncomboBox");
        ...
        // secondary drawer
        this.secondarydrawertransitionType = bindable.FindByName<SfComboBox>("secondarydrawertransitioncomboBox");
        this.secondarydrawertransitionType.SelectionChanged += this.OnSecondaryDrawerTransitionSelectionChanged;
        this.secondarydrawerpositionType = bindable.FindByName<SfComboBox>("secondarydrawerpositioncomboBox");
        this.secondarydrawerpositionType.SelectionChanged += this.OnSecondaryDrawerPositionSelectionChanged;
    ...
    {
        switch (transitionType!.SelectedItem?.ToString())
        {
            case "Push":
                this.navigationdrawer!.DrawerSettings.Transition = Transition.Push;
                break;

            case "Reveal":
                this.navigationdrawer!.DrawerSettings.Transition = Transition.Reveal;
                break;

            default:
                this.navigationdrawer!.DrawerSettings.Transition = Transition.SlideOnTop;
                break;
        }
    }
    ...
    /// <param name="sender">OnSelectionChanged sender</param>
    /// <param name="e">OnSelectionChanged event args e</param>
    private void OnSecondaryDrawerTransitionSelectionChanged(object? sender, Syncfusion.Maui.Inputs.SelectionChangedEventArgs e)
    {
        switch (secondarydrawertransitionType!.SelectedItem?.ToString())
        {
            case "Push":
                this.navigationdrawer!.SecondaryDrawerSettings.Transition = Transition.Push;
                break;

            case "Reveal":
                this.navigationdrawer!.SecondaryDrawerSettings.Transition = Transition.Reveal;
                break;

            default:
                this.navigationdrawer!.SecondaryDrawerSettings.Transition = Transition.SlideOnTop;
                break;
        }
    }
    ...
    /// <param name="sender">OnPositionSelectionChanged sender.</param>
    /// <param name="e">SelectionChangedEventArgs e.</param>
    private void OnSecondaryDrawerPositionSelectionChanged(object? sender, Syncfusion.Maui.Inputs.SelectionChangedEventArgs e)
    {
        if (secondarydrawerpositionType != null)
        {
            switch (secondarydrawerpositionType.SelectedItem?.ToString())
            {
                case "Right":
                    this.navigationdrawer!.SecondaryDrawerSettings.Position = Position.Right;
                    break;

                case "Top":
                    this.navigationdrawer!.SecondaryDrawerSettings.Position = Position.Top;
                    break;

                case "Bottom":
                    this.navigationdrawer!.SecondaryDrawerSettings.Position = Position.Bottom;
                    break;

                default:
                    this.navigationdrawer!.SecondaryDrawerSettings.Position = Position.Left;
                    break;
            }
        }
    }
    ...
    protected override void OnDetachingFrom(SampleView bindable)
    {
        ...
        this.secondarydrawertransitionType = null;
