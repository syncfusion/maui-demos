...
namespace SampleBrowser.Maui.XlsIO.XlsIO
{
    ...
    {
        public Syncfusion.XlsIO.IApplication? Application { get; private set; }
        public object? Parent { get; private set; }
        public string Address { get; set; }
        public string? Name { get; private set; }
        public Syncfusion.XlsIO.IRange? Range { get; private set; }
        public string ScreenTip { get; set; }
        public string SubAddress { get; set; }
        public string TextToDisplay { get; set; }
        public ExcelHyperLinkType Type { get; set; }
        public Syncfusion.XlsIO.IShape? Shape { get; private set; }
