...
namespace SampleBrowser.Maui.XlsIO.XlsIO
{
    ...
    /// </summary>
    public partial class ExcelToMarkdown : SampleView
    {
        #region Constructor
        /// <summary>
        ...
        public ExcelToMarkdown()
        {
            ...
            this.btnConvertToMarkdown.HorizontalOptions = Microsoft.Maui.Controls.LayoutOptions.Center;
#endif
        }
        #endregion
        ...
        {
            string inputPath = "SampleBrowser.Maui.Resources.XlsIO.ExcelToMarkdown.xlsx";
            if (BaseConfig.IsIndividualSB)
                inputPath = "SampleBrowser.Maui.XlsIO.Resources.XlsIO.ExcelToMarkdown.xlsx";
            ...
            if (input != null)
            {
                ...
                saveService.SaveAndView("ExcelToMarkdown.xlsx", "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet", stream);
        ...
        /// <param name="sender">contains a reference to the control/object that raised the event</param>
        /// <param name="e">contains the event data</param>
        private void btnConvertToMarkdown_Click(object sender, EventArgs e)
        {
            ...
            if (input != null)
            {
                ...
                book.SaveAs(stream, ExcelSaveType.Markdown);
                stream.Position = 0;
                SaveService saveService = new();
                saveService.SaveAndView("ExcelToMarkdown.md", "text/markdown", stream);
