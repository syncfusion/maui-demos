...
namespace SampleBrowser.Maui.PdfViewer.SfPdfViewer
{
    public class CustomToolbarViewModel : INotifyPropertyChanged
    {
        ...
        private Color _selectedFillColor = new();
        ...
        async internal void UpdateFileName(string? file)
        {
            switch (file)
            {
                ...
                case "Annotations PDF":
                    ...
                    break;
                case "Form PDF":
                    AssignPdfInfoAndLoad("form_document.pdf");
                    break;
            ...
            set
            {
                if (selectedAnnotation != value)
                {
                    ...
                    else
                    {
                        ...
                        else if (selectedAnnotation is InkAnnotation ink && !ink.IsSignature)
                        ...
                        else if (selectedAnnotation is StampAnnotation stamp &&!stamp.IsSignature)
                        ...
                        else if ((selectedAnnotation is StampAnnotation stampAnnotation && stampAnnotation.IsSignature) || (selectedAnnotation is InkAnnotation inkAnnotation && inkAnnotation.IsSignature))
                        {
                            BottomToolbarContent = new StampPropertyToolbar(this) { IsDeleteButtonVisible = true,IsOpacityButtonVisible=false };
                        }
#endif
        ...
        void SetSliderValues()
        {
            if (selectedAnnotation != null)
            {
                ...
                else if (selectedAnnotation is FreeTextAnnotation freetext)
                {
                    ...
                    SelectedColor = freetext.BorderColor;
            ...
            else
            {
                switch (pdfViewer.AnnotationMode)
                {
                    case AnnotationMode.Square:
                        ...
                        SelectedFillColor = pdfViewer.AnnotationSettings.Square.FillColor;
                        SelectedColor = pdfViewer.AnnotationSettings.Square.Color;
                        break;
                    ...
                    case AnnotationMode.Circle:
                        ...
                        SelectedFillColor = pdfViewer.AnnotationSettings.Circle.FillColor;
                        SelectedColor = pdfViewer.AnnotationSettings.Circle.Color;
                        break;
                    ...
                    case AnnotationMode.Line:
                        ...
                        SelectedColor = pdfViewer.AnnotationSettings.Line.Color;
                        break;
                    ...
                    case AnnotationMode.Polyline:
                        ...
                        SelectedColor = pdfViewer.AnnotationSettings.Polyline.Color;
                        break;
                    ...
                    case AnnotationMode.Polygon:
                        ...
                        SelectedFillColor = pdfViewer.AnnotationSettings.Polygon.FillColor;
                        SelectedColor = pdfViewer.AnnotationSettings.Polygon.Color;
                        break;
                    ...
                    case AnnotationMode.Arrow:
                        ...
                        SelectedColor = pdfViewer.AnnotationSettings.Arrow.Color;
                        break;
                    ...
                    case AnnotationMode.FreeText:
                        ...
                        SelectedColor = pdfViewer.AnnotationSettings.FreeText.BorderColor;
        ...
        internal void CloseOverlaysAndPalettes()
        {
            // FreeText related flyouts
        ...
        void OnToolbarCommand(object parameter)
        {
            if (parameter is string)
            {
                ...
                else if (parameter.Equals("ColorPalette"))
                {
                    ...
                    else if (pdfViewer.AnnotationMode == AnnotationMode.StickyNote || SelectedAnnotation is StickyNoteAnnotation)
                    {
                ...
                if (parameter.Equals("Annotations"))
                {
                    ...
                    //To dibale the free text font size list view and thickness silder bar visibility when click on annotation tool bar item in the primary tool bar
                    IsFreeTextFontSizeListViewVisible = false;
                    IsThicknessSliderbarVisible = false;
                }
                else if(parameter.Equals("Close"))
                {
                    ...
                    //To disbale the visibility of the free text font size list view, color palette, thickness slider bar when close button of annotation tool bar is clicked.
                ...
                if (parameter.Equals("Signature"))
                {
                    ...
                    IsStickyNoteMode = false;
                    ClearButtonHighlights();
                    SignatureHighlightColor = IsSignatureViewVisible ? Color.FromRgba(0, 0, 0, 20) : Colors.Transparent;
                }
        ...
        internal void HideDeskTopOverLays()
        {
            ...
            IsStampOpacitySliderbarVisible = false;
            IsStickyNoteColorPalleteVisible = false;
            //To disbale the visibility of the free text color pallete when annotation tool bar hides
            IsFreeTextFillColorVisble = false;
            IsLineAndArrowColorPalleteVisible = false;
        ...
        public void SetSelectedAnnotationIcon()
        {
            ...
            if ((SelectedAnnotation is InkAnnotation ink && ink.IsSignature) || (SelectedAnnotation is StampAnnotation stamp && stamp.IsSignature))
                SelectedAnnotationIcon = "\uE737";
            if (pdfViewer.AnnotationMode == AnnotationMode.Ink || (SelectedAnnotation is InkAnnotation inkAnnotation && !inkAnnotation.IsSignature ))
                SelectedAnnotationIcon = "\uE766";
            if (pdfViewer.AnnotationMode == AnnotationMode.InkEraser)
                SelectedAnnotationIcon = "\uE764";
            if (SelectedAnnotation is StampAnnotation stampAnnotation &&  !stampAnnotation.IsSignature)
                SelectedAnnotationIcon = "\uE761";
                ...
                if (selectedAnnotation != null)
                {
                    if (isFillColorToolbarVisible || isDeskTopFillColorToolbarVisible)
                    {
                        if (selectedAnnotation is ShapeAnnotation shape)
                        {
                            ...
                            SelectedFillColor = color.WithAlpha(SelectedFillColorOpacity);
                        }
                        else if (selectedAnnotation is FreeTextAnnotation freetext)
                        {
                            freetext.FillColor = color.WithAlpha(SelectedFillColorOpacity);
                        }
                        //To disbale visibility of the free text fill color pallete visibility when color is changed.
                        IsFillColorToolbarVisible = false;
                    }
                    else if (IsFreetextStrokeColorChanging || IsFreetextFontColorChanging || IsFreetextFillColorChanging)
                    {
                        ...
                        //To disbale visibility of the free text stroke color pallete visibility when color is changed.
                        IsColorToolbarVisible = false;
                    ...
                    else if (isColorToolbarVisible || isDeskTopColorToolbarVisible || isInkColorPalleteVisible || isLineAndArrowColorPalleteVisible || IsFreetextColorPalatteisible)
                    {
                        ...
                        if (selectedAnnotation is not FreeTextAnnotation)
                            SelectedColor = color.WithAlpha(SelectedOpacity);
                        //To disable the visibility of free text fill color palatte
                        IsColorToolbarVisible = false;
                        //To hide the color pallete of the sticky note when color is changeed.
                        IsStickyNoteColorPalleteVisible = false;
                    }
                }
                else
...
# endif
        ...
        internal async void ImportAnnotations()
        {
            ...
            {
                // Release the semaphore to allow next operations
        ...
        {
            // Wait to acquire the semaphore, ensuring no other operation interferes
            await _semaphoreSlim.WaitAsync();
            ...
            {
                // Reset the exporting flag and release the semaphore
                _semaphoreSlim.Release();
            }
        }
