...
namespace SampleBrowser.Maui.PdfViewer.SfPdfViewer
{
    ...
    public class SearchView : ContentView
    {
        ...
        internal event EventHandler? NoMoreMatchesFound;
        ...
        void GoToNextMatch()
        {
            ...
            UpdateStatus();
            if (SearchResult != null && SearchResult.TotalMatchesCount == (SearchResult.CurrentMatchIndex + 1) && SearchResult.TotalMatchesCount != 0)
            {
                NoMoreMatchesFound?.Invoke(this, EventArgs.Empty);
            }
        }
        ...
        void GoToPreviousMatch()
        {
            ...
            UpdateStatus();
            if (SearchResult != null && SearchResult.CurrentMatchIndex == 0 && SearchResult.TotalMatchesCount != 0)
            {
                NoMoreMatchesFound?.Invoke(this, EventArgs.Empty);
            }
        }
