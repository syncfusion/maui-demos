...
namespace SampleBrowser.Maui.PdfViewer.SfPdfViewer
{
    internal class SignaturePadDialog : Grid, IIntegratedSigatureDialog
    {
        ...
        //939174 - [WinUI] Create button is not visible in signature pad in custom toolbar
        private static readonly BindableProperty SignatureCreateButtonDisabledTextColorProperty = BindableProperty.Create("SignatureCreateButtonDisabledTextColorProperty", typeof(Color), typeof(SignaturePadDialog), defaultValue: Color.FromArgb("#6750A4"));
        ...
        internal SignaturePadDialog()
        {
            ...
            tabView.TabBarSize = 48;
            tabView.TabHeaderPadding = new Thickness(24, 0, 0, 0);
            ...
            thinBorder.Margin = new Thickness(0, tabView.TabBarSize, 0, 0);
