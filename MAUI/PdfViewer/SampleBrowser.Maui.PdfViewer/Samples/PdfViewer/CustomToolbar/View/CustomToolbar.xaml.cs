        ...
        if (e.PropertyName == nameof(viewModel.ColorPaletteMargin))
        {
            ...
            if (view != null)
            {
                ...
                if (viewModel.ColorPaletteMargin.Left + sizeRequest.Width > Width)
                    viewModel.ColorPaletteMargin = new Thickness(Width - sizeRequest.Width - 20, viewModel.ColorPaletteMargin.Top, viewModel.ColorPaletteMargin.Right, viewModel.ColorPaletteMargin.Bottom);
            }
        }
