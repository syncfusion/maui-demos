...
namespace SampleBrowser.Maui.AIAssistView.SfAIAssistView
{
    public class ControlTemplateViewModel : INotifyPropertyChanged
    {
        ...
        private bool enableStopResponse = true;
        ...
        public ControlTemplateViewModel()
        {
            ...
            this.HeaderItemTappedCommand = new Command<object>(HeaderItemTapCommand);
        ...
        public bool EnableStopResponse
        {
            get
            {
                return this.enableStopResponse;
            }
            set
            {
                this.enableStopResponse = value;
                RaisePropertyChanged(nameof(EnableStopResponse));
            }
        }
        ...
        private void UpdateNavigationButtons(int currentIndex)
        {
            ...
            if (currentIndex == headerInfoCollection.Count - 1)
            {
        ...
        private async void ExecuteStopResponding()
        {
            this.CancelResponse = true;
            this.EnableStopResponse = false;
        ...
        private async void HeaderItemTapCommand(object tappedItemText)
        {
            if (tappedItemText == null)
            {
                return;
            }
            this.enableNewChatIcon = false;
            requestItem = new AssistItem() { Text = tappedItemText.ToString(), IsRequested = true };
