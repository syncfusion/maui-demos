...
{
    public class ThermometerGauge1 : LinearGauge
    {
    ...
    public class ThermometerGauge2 : LinearGauge
    {
        public override System.Collections.Generic.List<GaugeLabelInfo> GenerateVisibleLabels()
        {
            System.Collections.Generic.List<GaugeLabelInfo> customLabels = new();
    ...
    public class TaskTrackerGauge : LinearGauge
    {
        public override System.Collections.Generic.List<GaugeLabelInfo> GenerateVisibleLabels()
        {
            System.Collections.Generic.List<GaugeLabelInfo> customLabels = new();
    ...
    public class SleepWatchScoreGauge : LinearGauge
    {
        public override System.Collections.Generic.List<GaugeLabelInfo> GenerateVisibleLabels()
        {
            System.Collections.Generic.List<GaugeLabelInfo> customLabels = new();
    ...
    public class ActiveHoursGauge : LinearGauge
    {
        public override System.Collections.Generic.List<GaugeLabelInfo> GenerateVisibleLabels()
        {
            System.Collections.Generic.List<GaugeLabelInfo> customLabels = new();
